...
const DonateForm = () => {
    ...
    return (
        ...
        <div className='w-full relative flex justify-between px-28 my-20 ' style={{ 'backgroundImage': `url(${banner})`, 'backgroundSize': 'cover', 'backgroundPosition': 'center' }}>
            <div className='absolute inset-0 bg-black bg-opacity-75'></div>
            <div className='relative z-10 bg-white w-[500px] px-10'>
                <h2 className='uppercase text-2xl my-5'><span className='text-primary font-bold'>Make</span> Donation</h2>
                <p className='text-primary'>Vivamus Pellentesque Ligula Id Arcu Congue, Ac Vulputate Sem Consequat. Cum Sociis Natoque Penatibus Et Magnis Dis Parturient Montes, Nascetur Ridiculus Mus.</p>
                ...
                <form onSubmit={handleSubmit} className="max-w-lg my-5">
                    ...
                    <div className="mb-4">
                        <input
                            ...
                            id="contact"
                            value={contact}
                            onChange={(event) => setContact(event.target.value)} placeholder='Email / Phone Number'
                            className="w-full px-3 py-2 border rounded-md text-gray-700 focus:outline-none focus:border-[#7abf18]"
                            required
                        />
                    </div>
                    ...
                    <div className="mb-4">
                        <select
                            ...
                            className="w-full px-3 py-2 border rounded-md text-gray-700 focus:outline-none focus:border-[#7abf18]"
                        >
                            <option value="" disabled className='text-gray-700'>Select Campaign</option>
                            {options.map(option => (
                    ...
                    <div className="mb-4">
                        ...
                        >
                            ...
                            <option value="$ Amount" className="text-gray-700">Write your own amount</option>
                        </select>
                    ...
                    <button type="submit" className="px-4 py-2 w-full font-bold text-white bg-[#7abf18] rounded-md ">
                        Donate
                    </button>
                </form>
            </div>
